...
use geoipapi\geoipapi\Utils\Retry;

/**
 * GeoIpBuilder is used to configure and build an instance of the SDK.
 */
class GeoIpBuilder
{
     ...
     * @return GeoIpBuilder
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): GeoIpBuilder
    {
     ...
     * @return GeoIpBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): GeoIpBuilder
    {
     ...
     * @return GeoIpBuilder
     */
    public function setServerIndex(int $serverIdx): GeoIpBuilder
    {
    ...
    public function setRetryConfig(Retry\RetryConfig $config): GeoIpBuilder
    {
    ...
    public function build(): GeoIp
    {
        ...
        return new GeoIp($this->sdkConfig);
    }
}